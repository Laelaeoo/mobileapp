...
$("header").textillate({
    ...
    setTimeout(
        function () {
            let popMessage = "いらしゃいませ!おみくじ引いってって";
...
btn1.addEventListener("click",function(){
    ...
    //             break;
    // }
    let resultText = ["大吉!!!","古!!!","中吉!!!","小吉!!!","末吉!!!","凶!!!"];
    ...
    letresultsMaxspeed=["10","10","8","5","5","5"];
    letresultMaxSize=["30","30","20","15","20","20"];
    letresultImage=["img/star.png","img/sakura hanabira.png","img/sakura hanabira.png","img/sakura hanabira.png","img/leaf.png","img/snowflakes.png"];
